...
with open("trainoutput2.p","rb") as bb:
        trainoutput = pickle.load(bb) 
with open("testinput2.p","rb") as cb:
        testinput = pickle.load(cb)
with open("testoutput2.p","rb") as db:
...
with open("bias2.p","wb") as ea:
    pickle.dump(bias,ea)
with open("weights2.p","wb") as fa:
